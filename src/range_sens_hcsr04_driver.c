...
void RANGE_SENS_init(range_sens_cb_fn cb_fn) {
  ...
  gpio_config(HCSR04_PULS_PORT, HCSR04_PULS_PIN_H, CLK_50MHZ, IN, AF0, OPENDRAIN, PULLDOWN);
  gpio_config(HCSR04_PULS_PORT, HCSR04_PULS_PIN_L, CLK_50MHZ, IN, AF0, OPENDRAIN, PULLDOWN);
